...
const cardData = [
  { title: "ADVANTIS PC 50/51/52/54" },
  { title: "HAYCARB PC 81" },
  { title: "FIBER PC 83" },
  { title: "CONSUMER PC 84" },
  { title: "AVENTURA PC 85" },
  { title: "AGRO PC 86" },
  { title: "DPL PC 87" },
  { title: "TTEL PC 88" },
  { title: "KVPL PC 89" },
  { title: "CORE ROUTERS PC 103/104" },
  { title: "SERVER FARM PC 109/123" },
  { title: "DEANS RD PC 122" },
  { title: "HBSI TWE 1/6/0/24 TWE 1/6/0/26" },
];
...
export default function CoreSwitchIncident() {
  const navigate = useNavigate();
  return (
    <div style={{ background: "#000", minHeight: "100vh", paddingTop: 40 }}>
      <button style={buttonStyle} onClick={() => navigate("/")}>Previous</button>
      <h1 style={{ color: "#fff", textAlign: "center", marginBottom: 40 }}>
        Core Switch Incident Report
      </h1>
      <div style={gridStyle}>
